...
const SignIn = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const response = await axios.post("/login", { email: formData.email, password: formData.password });
    ...
    <div className="flex flex-col items-center justify-center min-h-screen p-8">
      <div className="w-full max-w-md p-8 bg-white rounded-md">
        ...
        <form className="mt-10" onSubmit={handleSubmit}>
          <div className="mb-4">
            <label className="block text-sm font-medium mb-1 text-[#1a1619]" htmlFor="email">
              Email Address
            </label>
            <input 
              type="email"
          ...
          <div className="mb-4">
            <label className="block text-sm font-medium mb-1 text-[#1a1619]" htmlFor="password">
              Password
            </label>
